...
var MyTreeSelect = function (_React$Component) {
  ...
  _createClass(MyTreeSelect, [{
    ...
    value: function onChange(value, label, extra) {
      console.log(value, label, extra.triggerNode.props);
    ...
    value: function render() {
      var props = {
        ...
        treeCheckable: true,
        showCheckedStrategy: this.props.showCheckedStrategy || "SHOW_ALL", //SHOW_CHILD |  SHOW_ALL | SHOW_PARENT
      ...
      return _react2.default.createElement(_antd.TreeSelect, _extends({ treeDataSimpleMode: true }, props));
    }
  }]);

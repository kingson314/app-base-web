 ...
 * @module date
 */
var getNextDate = function getNextDate(nowDate, weekDay) {
  // 0是星期日,1是星期一,... 
  weekDay %= 7;
...
var fix = function fix(num, length) {
  return ('' + num).length < length ? (new Array(length + 1).join('0') + num).slice(-length) : '' + num;
};
var getXDate = function getXDate(year, weeks, weekDay) {
...
module.exports = (_module$exports = {
...
}, _defineProperty(_module$exports, "getTime", function getTime(time) {
  var date;
  if (time) {
    date = new Date(time);
  } else {
  ...
  return curdate;
}), _defineProperty(_module$exports, "getMinute", function getMinute(time) {
  var date;
  if (time) {
    date = new Date(time);
  } else {
  ...
  return curdate;
}), _defineProperty(_module$exports, "getNow", function getNow(time) {
  var date;
  if (time) {
    date = new Date(time);
  } else {
  ...
  var curdate = year + seperator1 + month + seperator1 + day + " " + hour + seperator2 + minute + seperator2 + second;
  return curdate;
}), _defineProperty(_module$exports, "getYear", function getYear() {
  return new Date().getFullYear();
}), _defineProperty(_module$exports, "getWeek", function getWeek() {
  var today = new Date();
  ...
  return result + 1;
}), _defineProperty(_module$exports, "getDate", function getDate(time, seperator1) {
  ...
  return curdate;
}), _defineProperty(_module$exports, "getDateTime", function getDateTime(time) {
  var date;
  if (time) {
    date = new Date(time);
  } else {
  ...
  return year + seperator1 + month + seperator1 + day + " " + hour + seperator2 + minute + seperator2 + second;
}), _defineProperty(_module$exports, "getTime", function getTime(time) {
  var date;
  if (time) {
    date = new Date(time);
  ...
  return hour + seperator2 + minute + seperator2 + second;
}), _defineProperty(_module$exports, "getPreMonth", function getPreMonth(date) {
  var arr = date.split('-');
  ...
  return t2;
}), _defineProperty(_module$exports, "getNextMonth", function getNextMonth(date) {
  var arr = date.split('-');
  var year = arr[0]; //获取当前日期的年份
  var month = arr[1]; //获取当前日期的月份
  var day = arr[2]; //获取当前日期的日
  ...
  var t2 = year2 + '-' + month2 + '-' + day2;
  return t2;
}), _defineProperty(_module$exports, "getDateRange", function getDateRange(_year, _week) {
  var beginDate;
  var endDate;
